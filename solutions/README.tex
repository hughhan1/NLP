...
In part(a) of grammar8, we want to capture the structures of sentences like these:
\begin{lstlisting}
Sally wanted to kiss every sandwich !               
Xiaochen failed to fly on every floor .             
The president managed to ate the floor .            
...
There are several kinds of infinitives, and infinitives have the ability to generate "infinitive phrase"s like "to fly on every floor", "to eat an apple", "to eat an apple and sigh", and "to understand that a president sighed". We use \code{INFP} to represent these infinitive phrases:
\begin{eqnarray*}
