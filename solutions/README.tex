...
(ROOT (S (NP (NP (Det every)
	...
	\item
        ...
        The entropy of \code{grammar3} is larger than the entropy of
        \code{grammar2} because \code{grammar3} can generate more varity of
        sentence, leading to more "creative" corpus.
        % TODO
	\item
